...
[![Files: ~353](https://img.shields.io/badge/Files-~353-blue.svg)]()
...
- **memory/** — 结构化知识库本体（**353 个** Markdown 文件，3.26 MB，覆盖 12 个域目录）
...
│       ├── avatar/   (76篇)  #   👤 Avatar — 改模/优化/Shader/信任与安全/Contacts
...
│       ├── rules/    (9篇)   #   ⚖️ 规则系统 — 语言限制/网络/性能/VM架构/Quest约束
...
│       └── _curator_tools/   #   🔮 策展工具 — A24 审计修复报告与脚本
│
...
> ⚠️ 通用 Chat 上下文窗口有限，建议按需加载具体域文件，不要一次加载全部 353 个文件。
...
| **Avatar** | 👤 | Animator、PhysBone、Shader (Poiyomi/lilToon/SCSS/ORL/Filamented/UnlitWF)、MA/VRCFury 工具链、优化、信任与安全、Contacts | 76 |
...
| **Rules** | ⚖️ | 硬约束（语言限制/网络/性能/VM 架构/深度陷阱/Quest 限制）| 9 |
| **Misc** | 📌 | 后处理、无障碍指南 | 4 |
...
| 🛡️ **A18/A19/A24 治理闭环** | 0 死链 / 100% YAML | 353 篇全部通过验证，26 死链清零，搜索可达率 99.6% |
...
| 版本 | 日期 | 核心变化 |
|------|------|---------|
| **v3.0.0** | 2026-07-01 | 内容规模化扩张：Poiyomi Shaders 8 主题入库 + 玩家知识库导入 + VCC/ALCOM 系统化 + OSC 协议 40% 扩充 + VPM 镜像站 57 仓库数据。A18/A19/A24 治理闭环：100% YAML 覆盖、0 死链、99.6% 搜索可达率。353 篇文档，3.26 MB。 |
