...
| **unorthodox** | 高 | ⭐⭐ | 特定 | 🔴 高 |
| **master-follower-syncer** ⭐NEW | 中 | ⭐⭐⭐⭐ | 中→大 | 低 |
| **exclusive-control-selector** ⭐NEW | 中 | ⭐⭐⭐⭐⭐ | 中→大 | 低 |
| **soft-detent-interpolation** ⭐NEW | 中 | ⭐⭐⭐⭐ | 中 | 低 |
| **fade-then-snap** ⭐NEW | 低 | ⭐⭐⭐⭐ | 小→中 | 低 |
| **editor-preview-component** ⭐NEW | 低 | ⭐⭐⭐⭐⭐ | 工具 | 低 |
| **material-propertyblock-safe-update** ⭐NEW | 低 | ⭐⭐⭐⭐⭐ | 通用 | 低 |
