...
**内容**: GitHub Actions CI/CD、VPM CLI、Repo Listing 格式
...
```markdown
> Type: API | RULE | PATTERN | SOURCE | REFERENCE
> Source: VRChat 官方文档 / VRChat Agent Skills 模板(参考工程) / 社区经验
...
| 缺口 | 建议 |
|------|------|
| `official-docs.md` 仅占位 | 建议合并到 `vrchatsdk/01_首页.md` 或扩展内容 |
...
| `memory/journal/` | 临时工作记录（来源追踪的中间产物） |
