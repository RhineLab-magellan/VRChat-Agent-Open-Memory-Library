...
> 当前版本: v3.00 (Persistence) | 路径（本地分析）: `C:\CherryStudio\Agent\UdonSharpAgent\参考工程\QuickBrown\LuraSwitch2\`
> 最后查看: 2026-06-20

> **🔄 双重身份说明**：
> - **A6 案例研究型**（本文件）：分析 39 个 .cs 源码 → 沉淀 6 个通用 Pattern（去项目化）
> - **C15 工具使用指南型**（`memory/world/luraswitch2.md`）：作为可推荐工具，含 BOOTH/UV License/9 种 Prefab/版本/安装教程
