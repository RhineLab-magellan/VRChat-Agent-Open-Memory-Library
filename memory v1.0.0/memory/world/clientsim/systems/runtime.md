...
> 来源: [VRChat Creator Docs - Runtime Systems](https://creators.vrchat.com/worlds/clientsim/systems/runtime/)
> 索引日期: 2026-06-15
...
> **任务范围说明**:本任务仅本地化 Runtime 父页面,18 个子页面均为**二级子页面**,不在本任务范围,可在后续任务中单独处理。
