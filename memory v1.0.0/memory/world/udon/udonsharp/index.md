...
**【FACT】** 是的。Udon 支持的所有功能 U# 都能访问。可通过 [Class Exposure Tree](https://github.com/Merlin-san/UdonSharp/wiki/class-exposure-tree) 验证（已本地化到 `memory/api/udon-type-exposure.md`）。
