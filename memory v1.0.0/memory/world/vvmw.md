...
> 当前版本: **1.6.0 稳定版** (2026-04-08) | **1.7.0-beta.1** (2026-04-13)
> Stars: 169
> 许可: VRChat 生态通用开源许可
> 沉淀日期: 2026-06-20
...
**VizVid (VVMW)** 是 VRChat 创作者生态中**最受欢迎的多人同步视频播放器之一**，由 JLChnToZ 维护。从 1.0.x 持续迭代到 1.7.0-beta.1，覆盖 VOD 视频、直播流、图片查看、AudioLink 集成、LTCGI 集成、VRC Light Volumes 集成等场景。
...
**向创作者推荐时**：
> 推荐使用 **VizVid (VVMW)** (v1.6.0)，JLChnToZ 维护，
