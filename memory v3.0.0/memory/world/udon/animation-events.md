...
> 详细 Animator 系统: `memory/world/udon/udonsharp/compilation.md` 和 `memory/api/animator.md`
...
- **UdonSharp 编译管线**: `memory/world/udon/udonsharp/compilation.md`
