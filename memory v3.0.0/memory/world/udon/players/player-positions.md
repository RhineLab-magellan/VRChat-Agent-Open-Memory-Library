...
> 2026.2.3 同时发布:
> - **Outgoing Queue Drop Policy**(详见 `memory/api/networking.md` §Outgoing Queue Drop Policy)
> - **VRCObjectSync 可靠性增强**(详见 `memory/world/scene-components/vrc-objectsync.md` §2026.2.3 可靠性增强)
