...
aliases:
  ...
  - compilation
related:
  - "world/udon/udonsharp/index.md"
  - "world/udon/udonsharp/configuration.md"
  - "world/udon/udonsharp/attributes.md"
  - "world/udon/udonsharp/performance-tips.md"
  - "rules/udonsharp-language-limits.md"
  - "rules/udon-vm-architecture.md"
  - "api/udonsharp-runtime.md"
  - "world/udon/vm-and-assembly.md"
---
# UdonSharp 编译管线

UdonSharp 1.x **迁移说明**: 本文档为 `memory/world/udon/udonsharp/compilation.md` 的权威位置。
